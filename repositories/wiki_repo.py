...
class FactsDropdown(Select):
    ...
    def __init__(self, facts: list, embed: discord.Embed, false_index: int) -> None:
        self.embed = embed
...
class FactsView(View):
    ...
    def __init__(self, *, timeout: float = 60, embed: discord.Embed, facts: list, false_index: int) -> None:
